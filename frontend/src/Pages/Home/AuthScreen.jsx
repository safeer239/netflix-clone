...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
        ...
        <button  className='bg-red-700 py-2 px-3 text-white text-xl rounded-md'><Link to={"/signup"}>Sign In</Link></button>
      </header>
        <div className='text-white flex flex-col items-center mx-auto py-40 max-w-6xl text-center justify-center'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col md:flex-row gap-3 w-1/2' action="">
            <input
                type="email"
              ...
              />
              <button className='bg-red-700 text-xl lg:text-2xl px-4 lg:px-6 py-1 md:py-2 rounded flex justify-center ic '>Get Started</button>
            </form>
        </div>
        ...
        <div className='py-10 bg-black text-white'>
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                ...
                <div className='flex-1 relative'>
                    ...
                    <video className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z-10' playsInline autoPlay={true} muted loop><source src='/hero-vid.m4v' type='video/mp4'/></video>
                </div>
            </div>
        </div>
        ...
        <div className='py-10 bg-black text-white'>
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className='text-lg md:text-xl'>Stream umlimited movies and TV shows on your phone, tablet, laptop, and TV.</p>
                </div>
        ...
        <div className='py-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
                <div className='flex-1 relative'>
                    <img src="/kids.png" className='mt-4' alt="" />
                </div>
                <div className='flex-1 text-center md:text-left'>
                    <h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Create profiles for kids</h2>
                    <p className='text-lg md:text-xl'>Send kids on adventures with thier favourite characters in a space made for them-free with your membership</p>
                </div>
            </div>
        </div>
    </div>
