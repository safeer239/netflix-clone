...
import { MOVIE_CATEGORIES, ORG_IMG_BASE_URL, TV_CATEGORIES } from '../../utils/baseUrl'
...
const HomeScreen = () => {
  ...
  return (
    ...
    <Navbar/>
    <img src={ORG_IMG_BASE_URL+trendingContent?.backdrop_path} alt="" className='absolute top-0 left-0 w-full h-full object-cover -z-50'/>
    <div className='absolute top-0 left-0 h-full w-full bg-black/50 -z-50' aria-hidden='true'/>
