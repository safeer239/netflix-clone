      ...
      <div className="flex justify-center items-center mt-20 mx-3">
        <div className="w-full max-w-md rounded-lg p-8 bg-black/60">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              <button className="bg-red-600 mt-2 text-white font-semibold text-xl w-full rounded-md p-2.5 hover:bg-red-700">Sign Up</button>
            </div>
          </form>
          <div className="text-center text-base text-gray-300 mt-3">
            Already have an account? <Link className="text-red-600 hover:underline" to={"/login"}> Sign In</Link>
          </div>
        </div>
      </div>
    </div>
